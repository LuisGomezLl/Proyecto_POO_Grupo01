...
public class JFrame_NuevoReclamo extends javax.swing.JFrame {
    ...
    private void crearNuevoReclamo(){
        ...
        String nombreee=txt_nombre.getText();
        String areaa=String.valueOf(cbarea.getSelectedIndex());
        String asuntoo=txtasunto.getText();
        String descrip = txtdescripcion.getText();
        
        if(areaa.isEmpty()||asuntoo.isEmpty()||descrip.isEmpty()||nombreee.isEmpty()){
            ...
            reclamo.setNombre(txt_nombre.getText());
    ...
    private void initComponents() {
        ...
        jPanel1.add(cbarea, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 150, 30));
        ...
        jPanel1.add(BtnRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 520, 110, 50));
        ...
        jPanel1.add(BtnGuardarReclamo, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 520, 110, 50));
        jPanel1.add(txtasunto, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, 190, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 280, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/iconoadminn.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 110, 210, 220));
        jPanel1.add(txt_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 190, 30));
