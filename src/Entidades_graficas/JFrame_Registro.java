...
public class JFrame_Registro extends javax.swing.JFrame {
    ...
    private void BtnCrearUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCrearUsuarioActionPerformed
        ...
        if(Ddni.isEmpty() || Dnombre.isEmpty() || Dtelefono.isEmpty() || Dusuario.isEmpty() || Dcontraseña.isEmpty()){
        
            JOptionPane.showMessageDialog(this, "Rellenar los espacios","Error",JOptionPane.ERROR_MESSAGE);
    ...
    private void usuarioRegistro(String Ddni, String Dnombre, String Dtelefono, String Dusuario, String Dcontraseña) {
        ...
        try {
            PreparedStatement st= (PreparedStatement)
                    dbconn.prepareStatement("INSERT INTO datos (dni,nombre,telefono,usuario,contraseña) VALUES(?,?,?,?,?)");
            ...
            JOptionPane.showMessageDialog(this, "Datos ingresados en la base de datos","EXITO",JOptionPane.INFORMATION_MESSAGE);
